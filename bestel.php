   ...
   <body>
      ...
      <main>
         <div class="info">
            ...
            <div>
            <a href=""><button class="bestel">BESTEL</button></a>
            </div>

         </div>
         <div class="foto">
            <img class="grijsr" id="shirt" src="img/rond/grijsr.png" height="400px" width="360px" alt="grijs shirt met ronde nek"></img>
            <p>op voorraad</p>
         </div>
      </main>
      <br> <br> <br> <br>
